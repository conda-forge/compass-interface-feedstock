About compass-interface-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/compass-interface-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12075&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/compass-interface-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `compass-interface, compass-interface-http, compass-interface-pandas` can be installed with `conda`:
...
```
mamba install compass-interface compass-interface-http compass-interface-pandas
```

It is possible to list all of the versions of `compass-interface` available on your platform with `conda`:
...
```
mamba search compass-interface --channel conda-forge
```
...
mamba repoquery search compass-interface --channel conda-forge

# List packages depending on `compass-interface`:
mamba repoquery whoneeds compass-interface --channel conda-forge

# List dependencies of `compass-interface`:
mamba repoquery depends compass-interface --channel conda-forge
```
